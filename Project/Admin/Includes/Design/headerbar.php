<header class="contianer d-flex justify-content-between p-3 bg-info t-0" style="width: -webkit-fill-available;">
    ...
    <ul class="nav">
        <li>
            <a role="button" class="btn btn-secondary m-2" href="../../Customer/HTML/Main.html" target="_blank">
        ...
        <li>
            ...
            <a role="button" class="btn btn-primary m-2" href="./logout.php" style="max-height: 44px;width: 150px;">
